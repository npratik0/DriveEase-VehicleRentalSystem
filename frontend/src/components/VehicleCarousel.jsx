...
//   const handleRent = () => {
//     // Handle rent logic here (e.g., save rental information, redirect to confirmation, etc.)
//     console.log('Renting vehicle:', car);
...
//             <div className="w-full h-64 overflow-x-auto flex space-x-4">
...
//       </div>
//       <div className="mt-8">
//         <h3 className="text-lg font-semibold mb-4">Rent This Vehicle</h3>
...
//           <button
//             type="submit"
//             className="bg-blue-600 text-white w-full py-2 rounded mt-4 hover:bg-blue-700 transition duration-300 cursor-pointer"
//           >
//             Rent Now
//           </button>
//         </form>
